...
The Recipe Buddy client will be tested extensively to ensure proper functionality across the top three major web browsers by marketshare including:
\begin{itemize}
    \item Google Chrome
    \item Apple Safari
    \item Mozilla Firefox
\end{itemize}
The Recipe Buddy client should function properly on other modern web browsers, but this is not guaranteed.
