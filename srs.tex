...
\begin{center}
    \begin{tabular}{c c c c}
        ...
        \midrule
        All team members & Sep 27 2021 & Initial doc        & 0.1     \\
        \midrule
    \end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item Reference 2
    \begin{itemize}
        \item Name: Safari Browser System Requirements
        \item Author: Apple
        \item Version: 15.0
        \item Access Date: September 29, 2021
        \item Location: \href{https://en.wikipedia.org/wiki/Safari_(web_browser)#System_requirements}{en.wikipedia.org}
    \end{itemize}
    \item Reference 3
    \begin{itemize}
        ...
        \item Version: 92.0
        \item Access Date: September 29, 2021
        \item Location: \href{https://www.mozilla.org/en-US/firefox/92.0/system-requirements/}{www.mozilla.org}
    \end{itemize}
\end{itemize}
...
The Recipe Buddy client relies on a web browser in order to properly fetch and display data within the Recipe Buddy sytem. Web browers are not operating system restricted as they run on all major operating systems.

\section{Communications Interfaces}
The Recipe Buddy client interface runs in a web browser and communicates via the HTTPs protocol. An internet connection of speed 2.5Mbps - 5Mbps is required to use the full features of Recipe Buddy such as the video tutorial and embedded videos within recipes.
