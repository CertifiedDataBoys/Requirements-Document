...
\begin{itemize}
    ...
    \item Recipe Buddy will interface with its database using a RESTful API. (TENTATIVE)
    \begin{itemize}

        \item RESTful API specifications: \href{https://restfulapi.net/}{restfulapi.net}
    ...
    \begin{itemize}
        ...
        \item Uploaded images must be no larger than 1024 x 768 pixels. (TENTATIVE)
        \item Uploaded images must be stored in .jpg, .png, or .webp file formats.
        \item Uploaded videos must be stored in .mp4 or .webm file formats.
        \item Uploaded files must be no more than 4MB in size. (TENTATIVE)
