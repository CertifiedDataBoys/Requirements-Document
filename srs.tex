...
\begin{itemize}
    \item REQ-1.1: Edit various elements of the recipe:
        \begin{itemize}
            \item Ingredients
            \item Time
            \item Temperature
            ...
            \item Instructions
        \end{itemize}
    \item REQ-1.2: Delete the selected recipe.
    \item REQ-1.3: Share the selected recipe:
        \begin{itemize}
...
\begin{itemize}
    \item REQ-2.1: View publicly available recipes and all relevant elements.
    \item REQ-2.2: Comment on recipe pages.
    \item REQ-2.3: Rate the quality of recipe pages.
    \item REQ-2.4: Rate comments.
\end{itemize}
...
\begin{itemize}
    \item REQ-3.1: For segments of the recipe that require timed steps.
    \item REQ-3.2: Can start, stop, and reset timer at any time.
\end{itemize}
...
\begin{itemize}
    \item REQ-4.1: Users have the ability to set the difficulty of the recipes that they create.
\end{itemize}
...
\begin{itemize}
    \item REQ-5.1: Rate the quality of a recipe. Recipes are rated out of 5 stars, with 1 stars indicating the lowest quality and 5 stars indicating the highest quality.
\end{itemize}
...
\begin{itemize}
    \item REQ-6.1: Comment on public recipes under a 300 character limit.
    \item REQ-6.2: Comments can be marked as a suggestion by the user
        \begin{itemize}
...
\begin{itemize}
    \item REQ-7.1: Upvote or downvote the public comments of users to indicate the quality of the comment.
\end{itemize}
