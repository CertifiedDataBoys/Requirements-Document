...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Guests are not allowed to store user-specific data such as favorited recipes, pantry items or cookware items.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Users can store user-specific data such as favorited recipes, pantry items or cookware items.
