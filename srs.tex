...
\begin{itemize}
    ...
    \begin{itemize}
        \item \gls{Recipe Buddy} shall not allow children, as defined by COPPA, to register for the service.
    ...
    \begin{itemize}
        ...
        \item \gls{Recipe Buddy} cannot treat a user exercising their CCPA rights any different from other users.
    \end{itemize}
\end{itemize}  
