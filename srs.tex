...
\begin{itemize}
    ...
    \item Recipe Buddy will interface with its database using a RESTful API.
    \begin{itemize}
    ...
    \item Recipe Buddy should be designed to save recipe data very quickly.
    \begin{itemize}
